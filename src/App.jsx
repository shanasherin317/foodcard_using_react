...
function App() {
  ...
  // let image= 'https://www.themealdb.com/images/media/meals/1548772327.jpg'
  // let title='title'
  // let para='Lorem, ipsum dolor sit amet consectetur adipisicing.'
  // console.log(data.length);

const dropdownclick=(event)=>{
console.log( event.target.value);
setDropdowncount(event.target.value);
  ...
  return (
    <>
    <div>
      <select name="" id="" className='dropdown' onClick={dropdownclick}>
   ...
   result.map(({strMeal,strMealThumb,idMeal})=>{
    return(
    <Card image={strMealThumb} para={idMeal} title={strMeal}/>
      )
   })
  }
    </div>
